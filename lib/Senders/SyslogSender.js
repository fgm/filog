...
var SyslogSender = function (_SenderBase) {
  ...
  _createClass(SyslogSender, [{
    ...
    value: function send(level, message, context) {
      ...
      if (typeof doc.context[_Logger2.default.KEY_TS] === "undefined") {
        doc.context[_Logger2.default.KEY_TS] = {
          server: {}
        };
      }

      // doc.context.timestamp.server is known to exist from above.
      _Logger2.default.prototype.stamp.call({ side: 'server' }, doc.context, 'send');
