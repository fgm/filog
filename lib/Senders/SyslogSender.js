 ...
 */
var modernSyslog = __importStar(require("modern-syslog"));
...
var SyslogSender = /** @class */ (function (_super) {
     ...
     */
    function class_1(ident, syslogOptions, syslogFacility, syslog, formatOptions, serialize) {
        if (ident === void 0) { ident = null; }
        if (syslogOptions === void 0) { syslogOptions = 0; }
        if (syslogFacility === void 0) { syslogFacility = null; }
        if (syslog === void 0) { syslog = null; }
        ...
        _this.facility = (typeof syslogFacility === null) ? _this.syslog.facility.LOG_LOCAL0 : syslogFacility;
