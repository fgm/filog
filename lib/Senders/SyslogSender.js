...
var SyslogSender = function (_SenderBase) {
  ...
  function SyslogSender() {
    ...
    var facility = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    _this.facility = facility || _this.syslog.facility.LOG_LOCAL0;
    _this.ident = actualIdent;
    _this.option = option || _this.syslog.option.LOG_PID;
