...
var MeteorClientHttpSender = function (_SenderBase) {
  ...
  function MeteorClientHttpSender(loggerUrl) {
    ...
    var _this = _possibleConstructorReturn(this, (MeteorClientHttpSender.__proto__ || Object.getPrototypeOf(MeteorClientHttpSender)).call(this));
  ...
  _createClass(MeteorClientHttpSender, [{
    ...
    value: function send(level, message, context) {
      ...
      this.http.post(this.loggerUrl, options, _NullFn2.default);
    }
  }]);
