...
var Logger = function () {
  ...
  _createClass(Logger, [{
    ...
    key: 'log',
    value: function log(level, message, rawContext) {
      var context = this.processors.reduce(function (accu, current, processorIndex, processors) {
        var result = Object.assign(accu, processors[processorIndex].process(current));
        return result;
      }, rawContext);
