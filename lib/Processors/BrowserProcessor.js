...
var BrowserProcessor = function (_ProcessorBase) {
  ...
  function BrowserProcessor(nav, win) {
    ...
    var actualNav = nav || (typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) === "object" && navigator;

    var actualWin = win || (typeof window === "undefined" ? "undefined" : _typeof(window)) === "object" && window;
