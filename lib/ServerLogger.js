...
var ServerLogger = /** @class */ (function (_super) {
     ...
     */
    ServerLogger.prototype.buildContext = function (details, source, context) {
        if (context === void 0) { context = {}; }
        var _a;
        // Ignore source and host keys from caller context.
        var _b = ISendContext_1.DETAILS_KEY, sourceDetails = context[_b], _c = ISendContext_1.SOURCE_KEY, ignoredSource = context[_c], _d = ISendContext_1.HOST_KEY, ignoredHostName = context[_d], _e = ISendContext_1.TS_KEY, sourceTs = context[_e], 
        // tslint:disable-next-line
        context1 = __rest(context, [typeof _b === "symbol" ? _b : _b + "", typeof _c === "symbol" ? _c : _c + "", typeof _d === "symbol" ? _d : _d + "", typeof _e === "symbol" ? _e : _e + ""]);
        // In case of conflict, argument details overwrites caller details.
        var mergedDetails = __assign({}, sourceDetails, details);
        var context2 = __assign({}, _super.prototype.buildContext.call(this, mergedDetails, source), (_a = {}, _a[source] = context1, _a[ISendContext_1.HOST_KEY] = this.hostname, _a[ISendContext_1.TS_KEY] = sourceTs, _a));
        return context2;
    };
    /**
    ...
    ServerLogger.prototype.handleClientLogRequest = function (req, res, _NEXT) {
        ...
        req.on("end", Meteor.bindEnvironment(function () {
            ...
            try {
                ...
                var _a = ISendContext_1.DETAILS_KEY, details = context[_a], nonDetails = __rest(context, [typeof _a === "symbol" ? _a : _a + ""]);
                _this.logExtended(level, message, details, nonDetails, ClientLogger_1.default.side);
                res.statusCode = 200;
                result = "";
            }
            catch (err) {
     ...
     */
    ServerLogger.prototype.logExtended = function (level, message, details, context, source) {
        var _a;
        this.validateLevel(level);
        var context1 = this.buildContext(details, source, context);
        var context2 = this.applyProcessors(context1);
        var _b = ISendContext_1.DETAILS_KEY, processedDetails = context2[_b], _c = ISendContext_1.SOURCE_KEY, processedSource = context2[_c], _d = source, processedSourceContext = context2[_d], _e = ISendContext_1.HOST_KEY, processedHost = context2[_e], _f = ISendContext_1.TS_KEY, processedTs = context2[_f], serverContext = __rest(context2, [typeof _b === "symbol" ? _b : _b + "", typeof _c === "symbol" ? _c : _c + "", typeof _d === "symbol" ? _d : _d + "", typeof _e === "symbol" ? _e : _e + "", typeof _f === "symbol" ? _f : _f + ""]);
        var context3 = (_a = {},
            _a[ISendContext_1.DETAILS_KEY] = processedDetails,
            _a[ISendContext_1.SOURCE_KEY] = processedSource,
            _a[source] = processedSourceContext,
            _a[ISendContext_1.HOST_KEY] = processedHost,
            _a[ISendContext_1.TS_KEY] = processedTs,
            _a[ServerLogger.side] = serverContext,
            _a);
    ...
    ServerLogger.prototype.logMethod = function (_a) {
        ...
        this.logExtended(level, message, {}, context, ClientLogger_1.default.side);
    };
    /**
