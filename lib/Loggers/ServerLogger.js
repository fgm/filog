...
var ServerLogger = /** @class */ (function (_super) {
     ...
     * @protected
     */
    ServerLogger.prototype.defaultContext = function (initialContext, source) {
        var _a;
        var cx1 = __assign((_a = {}, _a[IContext_1.HOST_KEY] = this._getHostname(), _a[IContext_1.SOURCE_KEY] = source, _a), initialContext);
        Logger_1.Logger.stamp(cx1, "log", this.side);
        return cx1;
    };
    /**
    ...
    ServerLogger.prototype.handleClientLogRequest = function (req, res, _NEXT) {
        ...
        req.on("end", Meteor.bindEnvironment(function () {
            ...
            try {
                ...
                var _a = IContext_1.DETAILS_KEY, details = context[_a], 
                // tslint:disable-next-line
                nonDetails = __rest(context, [typeof _a === "symbol" ? _a : _a + ""]);
                _this.logExtended(level, message, nonDetails, ClientLogger_1.ClientLogger.side);
                res.statusCode = 200;
                result = "";
            }
            catch (err) {
     ...
     * @inheritDoc
     */
    ServerLogger.prototype.log = function (level, message, rawContext) {
        rawContext.hostname = this.hostname;
        _super.prototype.log.call(this, level, message, rawContext);
    };
    /**
    ...
    ServerLogger.prototype.logExtended = function (level, message, context, source) {
        ...
        var cx1 = this.defaultContext(context, source);
    ...
    ServerLogger.prototype.logMethod = function (_a) {
        ...
        this.logExtended(level, message, context, ClientLogger_1.ClientLogger.side);
    };
    /**
